...
var InformationItem = module.exports = utils.revertibleModel(new Schema({
    ...
    category:{type:String, "enum":['test', 'statistics', 'infographic', 'graph'], required:true, editable:false},
    text_field:{type:Schema.Types.Text, required:true, editable:false},
