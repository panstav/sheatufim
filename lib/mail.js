...
var sendMail = exports.sendMail = function(to, body, subject, from, callback) {

    if(typeof from === "function" && typeof callback !== 'function') {
        callback = from;
        from = null;
    }
    if(!smtpTransport) {
...
var sendMailFromTemplate = exports.sendMailFromTemplate = function(to,string,callback) {
    ...
    var subject = 'עדכון מאתר מעגלי השיח של שיתופים';
    var body = parts[1] || parts[0];
    sendMail(to,body,subject, config.systemEmail, callback);
};