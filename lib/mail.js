...
var sendMailFromTemplate = exports.sendMailFromTemplate = function(to, string, email_details,callback) {
    ...
    var subject = 'עדכון מאתר ';
    subject += email_details.title ? email_details.title : "מעגלי השיח של שיתופים";
    var body = parts[1] || parts[0];
    var email = email_details.title ? email_details.title + " <" + email_details.email + ">" : null;
